...
if __name__ == "__main__":
    ...
    elif not buys and cash > 0:
        fidx = updated.index[0]
        updated.at[fidx, 'Nakit_Bakiye_USD'] = cash
        for xi in updated.index:
            if xi != fidx and updated.at[xi, 'Durum'] == 'CASH': updated.at[xi, 'Nakit_Bakiye_USD'] = 0.0
    ...
    for idx, row in updated.iterrows():
        if row['Durum'] == 'COIN':
            try:
                ...
                updated.at[idx, 'Kaydedilen_Deger_USD'] = float(row['Miktar']) * p
            except: pass
