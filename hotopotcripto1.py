...
def train_meta_learner(df, params=None):
    ...
    # Meta Öğreniciye Girdiler (Index Eşleştirme)
    meta_X = pd.DataFrame({
    ...
    # --- KRİTİK DÜZELTME: Sinyal Normalizasyonu ---
    ...
    # --- SİMÜLASYON DEĞİŞKENLERİNİN TANIMLANMASI (DÜZELTİLDİ) ---
